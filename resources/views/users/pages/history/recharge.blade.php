    ...
    <div class="network_team_rafer_wrapper">
        ...
        <div class="footer">
            <div class="footer_header">
                <div class="footer_header">
                    <a href="{{route('show_recharge_history_pending')}}" class="{{Route::is('show_recharge_history_pending') ? "btn-success" : "btn-site"}}">Under Pending</a>
                    <a href="{{route('show_recharge_history_success')}}" class="{{Route::is('show_recharge_history_success') ? "btn-success" : "btn-site"}}">Success</a>
                    <a href="{{route('show_recharge_history_rejected')}}" class="{{Route::is('show_recharge_history_rejected') ? "btn-success" : "btn-site"}}">Rejected</a>
                </div>
            </div>
            ...
            <div class="footer_body">
                @if ($historyDataCount < 1)
                    <div class="body">
                        <h2 class="main-header">You Don't have any recharge history.</h2>
                    </div>
                @endif
                    ...
                    <div class="box">
                        <div class="details">
                            ...
                            <div class="details_content">
                                ...
                                <p class="title">TranxID : {{$item['tranx']}}</p>
                            </div>
                        </div>
