...
<div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <input style="width: 100%;" type="text" name="bkash_number_notice" value="{{$adminData['bkash_number_notice']}}" placeholder="Payment notice...">
                        </li>
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <input style="width: 100%;" type="text" name="nagad_number_notice" value="{{$adminData['nagad_number_notice']}}" placeholder="Payment notice...">
                        </li>
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <input style="width: 100%;" type="text" name="rocket_number_notice" value="{{$adminData['rocket_number_notice']}}" placeholder="Payment notice...">
                        </li>
            ...
            <div class="col-md-6 mb-4">
                <div class="card" style="width: 100%;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <input style="width: 100%;" type="text" name="usdt_address_notice" value="{{$adminData['usdt_address_notice']}}" placeholder="Payment notice...">
                        </li>
        ...
        <div class="card" style="width: 100%;">
            ...
            <ul class="list-group list-group-flush">
                ...
                <form action="{{route('api_payment_genaration_com')}}" method="post">
                    <li class="list-group-item">
                        <input type="text" name="gen1st" value="{{$adminData['gen1st']}}" style="width: 100%;" placeholder="1st gen...">
                    </li>

                    <li class="list-group-item">
                        <input type="text" name="gen2nd" value="{{$adminData['gen2nd']}}" style="width: 100%;" placeholder="2nd gen...">
                    </li>

                    <li class="list-group-item">
                        <input type="text" name="gen3rd" value="{{$adminData['gen3rd']}}" style="width: 100%;" placeholder="3rd gen...">
                    </li>

                    <li class="list-group-item">
                        <input type="text" name="gen4th" value="{{$adminData['gen4th']}}" style="width: 100%;" placeholder="4th gen...">
                    </li>

                    <li class="list-group-item">
                        <input type="text" name="gen5th" value="{{$adminData['gen5th']}}" style="width: 100%;" placeholder="5th gen...">
                    </li>
                    <li class="list-group-item">
                        <button style="width: 100%;" type="submit" class="btn btn-success">UPDATE <i class="fa-solid fa-circle-check"></i></button>
                    </li>
    ...
    <div class="col-md-6 mb-4">
        <div class="card" style="width: 100%;">
            <div class="card-header">
                <h4 class="text-center text-primary">Doller rate</h4>
            </div>
            <ul class="list-group list-group-flush">
            <form action="{{route('api_payment_dollaer_rate')}}" method="post">
                <li class="list-group-item">
                    <input type="text" name="dollar_rate" value="{{$adminData['dollar_rate']}}" placeholder="Account balance...">
    ...
    <div class="col-md-12 mb-4">
        <div class="card" style="width: 100%;">
            <div class="card-header">
                <h4 class="text-center text-primary">User account</h4>
            </div>
            <ul class="list-group list-group-flush">
